                          ...
                          )
{
        ...
        __try
        {
                ...
                // 先判断进程名
                uPID = (ULONG)ProcessHandle ;
                bIsProtect = FindProtectProcessPID(uPID) ;
                ...
                bIsProtect = FindProtectProcessName(pProcessName) ;   
        }
        ...
        if (NULL != g_pNtTerminateProcess)
        {
                return g_pNtTerminateProcess(ProcessHandle, ExitStatus);
        }
